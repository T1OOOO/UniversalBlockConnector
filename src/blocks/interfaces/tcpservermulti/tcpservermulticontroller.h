#ifndef TCPSERVERMULTICONTROLLER_H
#define TCPSERVERMULTICONTROLLER_H
...
class TcpServerMultiController : public ByteArrayDataController {
  Q_OBJECT
  LOG4QT_DECLARE_QCLASS_LOGGER

public:
  explicit TcpServerMultiController(QObject *parent = nullptr);

  ~TcpServerMultiController() override;
...
protected:
  ...
  int getClientUsed() const;

  bool hasClientFree() const;

  void removeClient(QTcpSocket *sock);
...
private:
  ...
  QPointer<TcpServerMultiWidget> m_widget;
};

#endif // TCPSERVERMULTICONTROLLER_H
